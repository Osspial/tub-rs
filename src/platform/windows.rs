...
impl<'o> Window<'o> {
    ...
    pub fn set_title(&self, title: &str) {
        self.0.internal.set_title(title);
    }

    #[inline]
    pub fn show(&self) {
        self.0.internal.show();
    }

    #[inline]
    pub fn hide(&self) {
        self.0.internal.hide();
    }
    ...
    pub fn owner(&self) -> Option<&Window> {
        match self.0.owner() {
            ...
            // just transmute the reference to the internal window.
